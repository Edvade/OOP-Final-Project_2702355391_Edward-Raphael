...
public class FaceRecognition extends AuthenticationManager {
    ...
    // The main method to start the face recognition application
    public static void main(String[] args) {
        FaceRecognition fr = new FaceRecognition();
        fr.run();
    }

    // Initialize and run the face recognition system
    public void run() {
    ...
    // Start video preview to continuously update the capture panel
    ...
    // Capture an image from the webcam and perform the face recognition system
    ...
    // Process an image to extract features for face recognition
    ...
    private BufferedImage matToBufferedImage(Mat mat) {
        int type = BufferedImage.TYPE_3BYTE_BGR; //Make image coloured, not black and white
    ...
    //Boolean to print out login authentication prompt
    @Override
